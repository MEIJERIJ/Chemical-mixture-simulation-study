...
### Function to store Ridge results
#----------------------------------
run_Ridge <- function(obs, n_boot = 200, sim_id = 1, qlow, qhigh,  psi, joint_eff){
  ### Input:
  # - obs:        input dataset
  ...
  coef_ridge <- data.frame(
    ...
    Method = paste0("Ridge regression"),
    Size = nrow(obs),
